 ...
 * 1: 小班课，2: 1v1
 */
export type BaseRoomClassType = 1 | 2;
...
export function baseCreateRoomApi(data: Omit<BaseCreateRoomApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<BaseCreateRoomApiResponseData, BaseCreateRoomApiResponseData>(
      '/v1/base/createRoom',
      {
        ...data,
        type: sceneType
...
export function baseJoinRoomApi(data: Omit<BaseJoinRoomApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<BaseJoinRoomApiResponseData, BaseJoinRoomApiResponseData>(
      '/v1/base/joinRoom',
      {
        ...data,
        type: sceneType,
...
export function baseLeaveRoomApi(data: Omit<BaseLeaveRoomApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<baseLeaveRoomApiResponseData, baseLeaveRoomApiResponseData>(
      '/v1/base/leaveRoom',
      {
        ...data,
        type: sceneType,
...
export function baseListRoomApi(data: Omit<BaseListRoomApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().get<BaseListRoomApiResponseData, BaseListRoomApiResponseData>(
      '/v1/base/listRoom',
      {
        params: {
          ...data,
...
export function baseHeartBeatApi(data: Omit<BaseHeartBeatApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().get<BaseHeartBeatApiResponseData, BaseHeartBeatApiResponseData>(
      '/v1/base/heartBeat',
      {
        params: {
          ...data,
...
export function baseGetRoomInfoApi(data: Omit<BaseGetRoomInfoApiRequestData, 'type'>) {
  const { roomId } = data;
  return httpRequestUtil.getInstance().get<BaseGetRoomInfoApiResponseData, BaseGetRoomInfoApiResponseData>(
...
export function baseUpMicApi(data: Omit<BaseUpMicApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<BaseUpMicApiResponseData, BaseUpMicApiResponseData>(
      '/v1/base/upMic',
      {
        ...data,
        type: sceneType,
...
export function baseUpdateRoomAttrApi(data: Omit<BaseUpdateRoomAttrApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<BaseUpdateRoomAttrApiResponseData, BaseUpdateRoomAttrApiResponseData>(
...
export function baseUpdateMicAttrApi(data: Omit<baseUpdateMicAttrApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post(
...
export function baseDownMicApi(data: Omit<BaseDownMicApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().post<BaseDownMicApiResponseData, BaseDownMicApiResponseData>(
      '/v1/base/downMic',
      {
        ...data,
        type: sceneType,
...
export function baseGetRoomMicInfoApi(data: Omit<BaseGetRoomMicInfoApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().get<BaseGetRoomMicInfoApiResponseData, BaseGetRoomMicInfoApiResponseData>(
...
export function baseGetRoomAttrApi(data: Omit<BaseGetRoomAttrApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().get<BaseGetRoomAttrApiResponseData, BaseGetRoomAttrApiResponseData>(
      '/v1/base/getRoomAttr',
      {
        params: {
          ...data,
...
export function baseGetMicAttrApi(data: Omit<BaseGetMicAttrApiRequestData, 'type'>) {
  return httpRequestUtil.getInstance().get<BaseGetMicAttrApiResponseData, BaseGetMicAttrApiResponseData>(
      '/v1/base/getMicAttr',
      {
        params: {
          ...data,
